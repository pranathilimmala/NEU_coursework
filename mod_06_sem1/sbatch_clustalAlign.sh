...
# Usage
###
# Copy sbatch_clustalAlign.sh and clustalAlign.sh to your /scratch/limmala.p/ directory (or subdirectory)
# From that same directory run this command: 
# sbatch sbatch_clustalAlign.sh /scratch/limmala.p/module06-pranathibinf/
#
# ASSUMES that input apoe_aa.fasta is also in the /scratch/limmala.p/module06-pranathibinf/
