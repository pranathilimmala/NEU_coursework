...
#SBATCH --mail-user=limmala.p@northeastern.edu # Update to your user name!

# Usage: sbatch sbatch_transcriptome.sh
# Assumes input data is in /home/limmala.p/data/ 
...
cp -r /home/limmala.p/data/trimmed data/trimmed
echo "Moving alignment files to working directory"
cp -r /home/limmala.p/data/bam data/bam
cp -r /home/limmala.p/data/sam data/sam
...
cp -r results/trinity_guided /scratch/limmala.p/module-08-pranathibinf/data/trinity_guided
cp -r results/trinity_de_novo /scratch/limmala.p/module-08-pranathibinf/data/trinity_de_novo
cp results/trinity*stats.txt /scratch/limmala.p/module-08-pranathibinf/data/
